// ^http:\/\/scrm\.bkchina\.cn\/scrm-bk-wechat\/activityController\/collectCardTask.do$
const $ = new Env('汉堡王任务')
$.signKey = 'session_bargerking'
    ...
    return new Promise((resolve) => {
        ...
        const url = { 
           ...
           headers: {
                ...
                'User-Agent' : `Mozilla/5.0 (iPhone; CPU iPhone OS 15_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.20(0x18001442) NetType/WIFI Language/en`,
                'Referer' : `http://scrm.bkchina.cn/scrm-bk-wechat/view/setpoint/setPointActivityInit.html?activityCode=VIVJDKE8P2OVJK&shareCode=null&v=20220604115042`,
