// ^https:\/\/kuai\.imdada\.cn\/toc\/corp\/growth\/points\/signIn\?
const $ = new Env('闪送')
$.signurlKey = 'signurl_shansong'
$.signheaderKey = 'signheader_shansong'
...
function sign() {
  ...
  $.get(url, (error, response, data) => {
    ...
    let subTitle = `结果：签到天数${result.content.checkInRewardSummary.maxCheckInDays}天`
    $.msg($.name, subTitle)
    $.done()
  })
}
